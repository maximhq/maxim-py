            ...
            if use_simulation_endpoints:
                ...
                for key, value in row.items():
                    if isinstance(value, str):
                        ...
                        data_entry[key] = [str(v) for v in value]
                    else:
                ...
                simulation_output = self._poll_simulation_result(fetch, parse, logger)
            ...
            if use_simulation_endpoints:
                ...
                for key, variable in variables.items():
                    if variable.type == "text":
                        ...
                        data_entry[key] = str(variable.payload) if variable.payload else None
