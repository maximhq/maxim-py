...
class MaximAPI:
    ...
    def get_upload_url_for_dataset_attachment(self, dataset_id: str, entry_id: str, key: str, columnId: str, mime_type: str, size: int) -> DatasetAttachmentUploadURL:
        """
        ...
        Args:
            ...
            columnId: The column identifier within the dataset
