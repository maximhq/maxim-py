...
ARG PROGRAM_MAIN="maxim/tests/test_livekit_push_to_talk_copy.py"
...
# Note: ML models and files will be downloaded at runtime when environment variables are available
# This ensures secrets are not baked into the Docker image
...
CMD ["uv", "run", "maxim/tests/test_livekit_push_to_talk.py", "start"]
